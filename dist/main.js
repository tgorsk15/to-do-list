...
.task-title-container {
    margin-bottom: 8px;
    margin-left: 35px;
}`, "",{"version":3,"sources":["webpack://./src/projectBar.css"],"names":[],"mappings":";;AAEA,2BAA2B;;AAE3B;IACI,aAAa;IACb,sBAAsB;IACtB,kBAAkB;IAClB,WAAW;IACX,kBAAkB;AACtB;;AAEA;IACI,aAAa;AACjB;;AAEA;IACI,cAAc;IACd,kBAAkB;IAClB;yBACqB;IACrB,SAAS;AACb;;AAEA;IACI,aAAa;IACb,sBAAsB;IACtB,6BAA6B;IAC7B,kBAAkB;AACtB;;AAEA;IACI,gBAAgB;IAChB;8BAC0B;IAC1B,mBAAmB;AACvB;;AAEA;IACI,YAAY;IACZ,WAAW;IACX,gCAAgC;IAChC,YAAY;IACZ,YAAY;IACZ,kBAAkB;IAClB,iBAAiB;IACjB,mBAAmB;AACvB;;AAEA;IACI,kBAAkB;IAClB,iBAAiB;AACrB","sourcesContent":["\n\n/* styling for ProjectBar */\n\n.projects-container {\n    display: flex;\n    flex-direction: column;\n    align-items: start;\n    grid-row: 2;\n    grid-column: 1 / 2;\n}\n\n.task-form-container {\n    display: none;\n}\n\n.task-form-container-active {\n    display: block;\n    position: absolute;\n    /* min-height: 110px;\n    width: max-content; */\n    top: 10px;\n}\n\n.project-cont {\n    display: flex;\n    flex-direction: column;\n    justify-content: space-evenly;\n    align-items: start;\n}\n\n.project-title {\n    overflow: hidden;\n    /* white-space: nowrap;\n    text-overflow: ellipsis; */\n    margin-bottom: 10px;\n}\n\n.add-task-button {\n    height: 25px;\n    width: 25px;\n    background-color: blanchedalmond;\n    border: none;\n    color: black;\n    border-radius: 50%;\n    margin-left: 35px;\n    margin-bottom: 15px;\n}\n\n.task-title-container {\n    margin-bottom: 8px;\n    margin-left: 35px;\n}"],"sourceRoot":""}]);
// Exports
